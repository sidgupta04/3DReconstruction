...
calibimgfiles = '/Users/siddharthgupta/Desktop/CS 117/calib/*.png'
...
# Compute extrinsics and add to dict
extrinsics = []
for rvec, tvec in zip(rvecs, tvecs):
    R, _ = cv2.Rodrigues(rvec)
    extrinsics.append({"R": R, "t": tvec})
calib["extrinsics"] = extrinsics

# Now save everything
with open(resultfile, "wb") as fid:
